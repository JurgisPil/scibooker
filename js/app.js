import { dataApi } from './data.js?v=18';
import { auth, googleProvider } from './firebase.js?v=18';
import { signInWithPopup, onAuthStateChanged, signOut } from 'https://www.gstatic.com/firebasejs/10.8.1/firebase-auth.js';
import { renderDashboard, renderCalendarView, renderMyBookings, renderAdminPanel } from './components.js?v=18';
